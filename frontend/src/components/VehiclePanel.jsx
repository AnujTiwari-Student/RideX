...
import { setSelectedVehicle } from '@/features/selectedVehicleSlice'

const VehiclePanel = ({setVehiclePanel , selectedVehiclePanel , fare}) => {
      ...
      <div className='flex items-center justify-between w-full mb-4 mt-2'>
        ...
        onClick={()=> {
          ...
          <div className='flex items-start justify-between w-full'>
            ...
            <h5 className='text-lg font-semibold pr-5'>₹{fare?.car ? Math.round(fare.car) : "N/A"}</h5>
          </div>
        </div>
        <div className={`flex w-full rounded-xl items-center gap-4 py-3 cursor-pointer ${
        ...
        onClick={()=>{
          ...
          <div className='flex items-start justify-between w-full'>
            ...
            <h5 className='text-lg font-semibold pr-5'>₹{fare?.auto ? Math.round(fare.auto) : "N/A"}</h5>
          </div>
        </div>
        <div className={`flex w-full rounded-xl items-center gap-4 py-3 cursor-pointer ${
        ...
        onClick={() => {
          ...
          <div className='flex items-start justify-between w-full'>
            ...
            <h5 className='text-lg font-semibold pr-5'>₹{fare?.motorcycle ? Math.round(fare.motorcycle) : "N/A"}</h5>
          </div>
        </div>
    </>
  )
